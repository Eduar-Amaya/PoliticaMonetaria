...
# En general un modelo VAR de orden n, estaria representado por:
# Y_{t} = A_{0} + \sum _{s=1}^{n} A_{s}* Y_{t-s} + u_{t}: donde
# Y_{t} es un vector columna de k*1
# n es el orden del modelo VAR o numero de retardos de cada variable en cada ecuacion
# u_{t} es un vector de k*1 de innovaciones, es decir procesos sin autocorrelacio.  
